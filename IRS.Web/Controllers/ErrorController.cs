...
namespace IRS.Web.Controllers
{
    ...
    public class ErrorController : Controller
    {
        ...
        public ErrorController(ICategoryInfoService categoryInfoService)
        {
        ...
        {
            var addresslist = _categoryInfoService.LoadEntities(c => c.CategoryInfoType == 2);
            return Json(new
            {
                data = addresslist
            });
        ...
        {
            var address = _categoryInfoService.LoadEntities(c => c.CategoryInfoId == id && c.CategoryInfoType == 2).FirstOrDefault();
            return Json(new
            {
                data = address
            });
        ...
        {
            var result = _categoryInfoService.LoadEntities(c => c.CategoryInfoId == id && c.CategoryInfoType == 2).FirstOrDefault();

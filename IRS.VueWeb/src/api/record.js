...
export function getInfo(searchObj = {}, page = 1, pageSize = 10) {
  return fetch({
    ...
    params: {
      page,
      pageSize,
      RecordUser: searchObj.RecordUser,
      UserDorm: searchObj.UserDorm,
      RecordTime: searchObj.RecordTime
    }
  })
}

export function getAllInfo(searchObj = {}) {
  return fetch({
    url: '/api/record/All',
    method: 'get',
    params: {
...
export function SearchModel(RecordUser = '', UserDorm = '', RecordTime = '') {
  this.RecordUser = RecordUser
  this.UserDorm = UserDorm
  this.RecordTime = RecordTime
}

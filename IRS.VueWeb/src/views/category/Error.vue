    ...
    <div id="address">
        <div id="datagrid">
            ...
            <el-table :data="tableData" border style="width: 100%" :row-style=rowStyle :header-cell-style=rowStyle>
                ...
                <el-table-column prop="categoryInfoName" label="故障分类名称" sortable width="180">
                </el-table-column>
                <el-table-column prop="categoryInfoOrder" label="故障分类排序" sortable width="200">
                </el-table-column>
            ...
            <!-- 修改故障分类信息 -->
            <el-dialog title="修改故障分类信息" :visible.sync="editDialogFormVisible" @close="cancel()">
                <el-form ref="form" :model="form" label-position="top" label-width="80px">
                    <el-row class="first-row">
                        ...
                        <el-col :span="12">
                            <el-form-item label="故障分类排序">
                                <el-input v-model="form.categoryInfoOrder" placeholder=''></el-input>
                            </el-form-item>
                            <el-form-item label="故障分类Id" v-if="false">

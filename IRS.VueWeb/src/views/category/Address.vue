    ...
    <div id="address">
        <div id="datagrid">
            ...
            <el-table :data="tableData" border style="width: 100%" :row-style=rowStyle :header-cell-style=rowStyle>
                ...
                <el-table-column prop="categoryInfoName" label="宿舍楼名称" sortable width="180">
                </el-table-column>
                <el-table-column prop="categoryInfoOrder" label="宿舍楼排序" sortable width="200">
                </el-table-column>
            ...
            <!-- 修改宿舍楼信息 -->
            <el-dialog title="修改宿舍楼信息" :visible.sync="editDialogFormVisible" @close="cancel()">
                <el-form ref="form" :model="form" :rules="rules" label-position="top" label-width="80px">
                    ...
                    <el-row class="last-row">
                        <el-col :span="24" class="first-column" style="height: 100%">
        ...
        data() {
            return {
                ...
                rules: {
                    ...
                    categoryInfoOrder: [
                        { required: true, message: '请输入宿舍楼排序', trigger: 'blur' }
                    ]
                }
            }
        },

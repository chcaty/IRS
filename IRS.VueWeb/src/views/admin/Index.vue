  ...
  <div id="admin">
    <el-form id="toolbar" :inline="true" :model="searchForm" class="demo-form-inline">
      <el-form-item label="姓名">
        <el-input v-model="searchForm.UserName" placeholder="用户姓名"></el-input>
      </el-form-item>
      <el-form-item label="登录名">
        <el-input v-model="searchForm.UserCode" placeholder="系统登录名"></el-input>
      </el-form-item>
      <el-form-item>
    ...
    <div id="datagrid">
      ...
      <el-table :data="tableData" :border="true" style="width: 100%" @select-all="selectChange" @selection-change="selectChange" v-loading="loading">
        ...
        <el-table-column prop="roleName" label="角色" class="box"></el-table-column>
      ...
      <el-dialog title="用户信息" :visible.sync="editDialogFormVisible" :close-on-click-modal="false" @close="cancel();">
        <el-form :model="form" label-width="80px" label-position="top">
          <el-row class="first-row">
            ...
            <el-col :span="10">
              <el-form-item label="登录名">
                <el-input v-model="form.userCode" required :disabled="isEdit"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          ...
          <el-row class="last-row" style="height: 290px; overflow: hidden">
            <el-col :span="10" class="first-column" :offset="2" style="height: 100%">
              <el-form-item label="密码" prop="password">
                <el-input type="password" required v-model="form.userPwd"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="10" style="height: 100%">
              <el-form-item label="用户角色">
                <el-select v-model="form.roleId" required placeholder="用户角色">
      ...
      <el-dialog title="密码重置" :visible.sync="resetDialogFormVisible" :close-on-click-modal="false">
        <el-form :model="form2" label-width="100px">
          <el-form-item label="请输入新密码">
            <el-input v-model="form2.psw" required type="password"></el-input>
          </el-form-item>
          <el-form-item label="再次确认密码">
            <el-input v-model="form2.newpsw" required type="password"></el-input>
          </el-form-item>
        </el-form>
    ...
    updateData() {
      updateInfo(this.uploadId, this.form)
        .then(response => {
          ...
          if (result == 200) {
            let currentId = this.form.userId;
            let record = 0;
